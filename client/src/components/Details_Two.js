...
const Details_Two = () => {
    ...
    return (
        <div className="container mt-3">
            ...
            <div className="mt-3">
                <button className="btn btn-#2FBFC6" onClick={() => setFontColor('#2FBFC6')} style={{ backgroundColor: '#2FBFC6' }}>Color 1</button>
                <button className="btn btn-warning" onClick={() => setFontColor('orange')} style={{ backgroundColor: 'orange', marginLeft:6  }}>Color 2</button>
                <button className="btn btn-#DAE8E9" onClick={() => setFontColor('#DAE8E9')} style={{ backgroundColor: '#DAE8E9', marginLeft:6  }}>Color 3</button>
            ...
            <Card sx={{ maxWidth: 900,marginBottom:6,backgroundColor: '#243928eb',color:'#dae2e3eb',fontFamily: 'monospace' }} ref={componentRef}>
                <CardContent>

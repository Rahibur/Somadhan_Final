...
const Details_Three = () => {
    ...
    return (
        <div className="container mt-3">
            ...
            <div className="mt-3">
                <button className="btn btn-#DAE8E9" onClick={() => setFontColor('#DAE8E9')} style={{ backgroundColor: '#DAE8E9' }}>Color 1</button>
                <button className="btn btn-warning" onClick={() => setFontColor('orange')} style={{ backgroundColor: 'orange', marginLeft:6  }}>Color 2</button>
                <button className="btn btn-yellow" onClick={() => setFontColor('yellow')} style={{ backgroundColor: 'yellow', marginLeft:6  }}>Color 3</button>
            ...
            <Card sx={{ maxWidth: 900,marginBottom:6,backgroundColor: '#458d86',color:'#dde4e5',fontFamily: 'math'}} ref={componentRef}>
                <CardContent>
